...
'''Algoritmo que implementa o Método Numérico de Runge-Kutta-Fehberg 45 na equação diferencial que modela 
...
def abrir_arquivo():
    arquivo = open("../Dados/Problema3-Método-Runge-Kutta-Fehlberg-45.txt", "w")
...
def plotar_grafico(coordenadas_x, coordenadas_y):
    ...
    plt.savefig('../Gráficos/Problema-3-Runge-Kutta-Fehlberg-45.png',format='png',dpi=300)
    plt.show()
