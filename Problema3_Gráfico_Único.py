...
import Problema3_Método_Euler as euler
import Problema3_Método_Euler_Modificado as emo
import Problema3_Método_Euler_Melhorado as eme
import Problema3_Método_Runge_Kutta_3_Ordem as rk3
import Problema3_Método_Runge_Kutta_Gill as rkg
import Problema3_Método_Runge_Kutta_4_Ordem as rk4
import Problema3_Método_Runge_Kutta_Fehlberg_45 as rkf45
import Problema3_Método_Runge_Kutta_Fehlberg_54 as rkf54
...
def main():
	...
	#Detalhes
	plt.grid(True)
	plt.title('Produtos Químicos')
	plt.xlabel('Tempo')
	plt.ylabel('Concentração de Produtos Químicos')
	plt.savefig('../Gráficos/Problema3_Todos_F_0_1_V_8',format='png',dpi=600)
	plt.show()
