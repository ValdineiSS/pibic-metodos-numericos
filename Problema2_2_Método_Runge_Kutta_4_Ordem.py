...
def abrir_arquivo():
	arquivo = open("../Dados/Problema2-2-Método-Runge-Kutta-4-Ordem.txt", "w")
...
def plotar_grafico(coordenadas_x, coordenadas_y):
	...
	plt.savefig('../Gráficos/Problema-2-2-Runge-Kutta-4-Ordem.png', format='png', dpi=300)
	plt.show()
...
def main():
	...
	while(x <= 100):
		...
		#Atualizações
		S = metodo_runge_kutta(S, h, k1, k2, k3, k4)
		x = x + h
