...
def abrir_arquivo():
	arquivo = open("../Dados/Problema3-Método-Euler-Melhorado.txt", "w")
...
def plotar_grafico(coordenadas_x, coordenadas_y):
	...
	plt.savefig('../Gráficos/Problema-3-Euler-Melhorado.png',format='png',dpi=300)
	plt.show()
...
def main():
	...
	while(t <= 20):
		...
		#Derivadas
		k1 = edo(Q, t)
		k2 = edo(metodo_euler(Q, h, edo(Q, t)), t)
