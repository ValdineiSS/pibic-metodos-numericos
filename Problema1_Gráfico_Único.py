...
import Problema1_Método_Euler as euler
import Problema1_Método_Euler_Modificado as emo
import Problema1_Método_Euler_Melhorado as eme
import Problema1_Método_Runge_Kutta_3_Ordem as rk3
import Problema1_Método_Runge_Kutta_Gill as rkg
import Problema1_Método_Runge_Kutta_4_Ordem as rk4
import Problema1_Método_Runge_Kutta_Fehlberg_45 as rkf45
import Problema1_Método_Runge_Kutta_Fehlberg_54 as rkf54
...
def main():
	...
	plt.title('Misturas')
	plt.xlabel('Tempo')
	plt.ylabel('Concentração de Sal')
	plt.savefig('../Gráficos/Problema1_Gráfico_Único_Métodos_Passo_Fixo_1',format='png',dpi=600)
	plt.show()
